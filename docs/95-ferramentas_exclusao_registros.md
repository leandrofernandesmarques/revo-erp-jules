# Análise do Módulo Ferramentas - Exclusão de Registros - ERP Revo

## Estrutura Geral

O módulo "Ferramentas - Exclusão de Registros" do ERP Revo apresenta uma interface para gerenciamento de tarefas de exclusão de registros do sistema. A página permite visualizar tarefas de exclusão existentes, criar novas tarefas e aplicar filtros de pesquisa. Quando não há tarefas cadastradas, a interface exibe uma mensagem informativa e um botão para incluir uma nova tarefa de exclusão.
...
<div class="cabecalho-container">
  <div class="breadcrumb">
    ...
    <span class="breadcrumb-separador">/</span>
    <span class="breadcrumb-item-atual">Exclusão de registros</span>
  </div>

  <div class="cabecalho-titulo">
    <h1 class="titulo-pagina">Exclusão de registros</h1>
  </div>

  <div class="cabecalho-acoes">
    <a href="/incluir_tarefa_exclusao" class="botao botao-primario">
      <span class="botao-icone icone-adicionar"></span>
      <span class="botao-texto">Incluir tarefa exclusão</span>
    </a>
  </div>
</div>
```
...
A seção de filtros permite pesquisar e filtrar as tarefas de exclusão:
...
<div class="filtros-container">
  ...
  <div class="filtros-acoes">
    <a href="/exclusao_registros?filtro=em_aberto" class="filtro-link">
      <span class="filtro-texto">Em aberto</span>
    </a>

    <a href="/exclusao_registros?filtro=por_periodo" class="filtro-link">
      <span class="filtro-icone icone-calendario"></span>
      <span class="filtro-texto">por período</span>
    </a>

    <a href="/exclusao_registros" class="filtro-link filtro-limpar">
...
Quando não há tarefas de exclusão cadastradas, a interface exibe uma mensagem informativa:
...
<div class="conteudo-container">
  <div class="estado-vazio">
    <div class="estado-vazio-conteudo">
      ...
      <a
        href="/incluir_tarefa_exclusao"
        class="botao botao-primario estado-vazio-acao"
      >
        <span class="botao-texto">Incluir tarefa exclusão</span>
      </a>
  ...
  <div class="ajuda-container">
    ...
    <a href="/ajuda/exclusao_registros" class="ajuda-link"
      >Acesse a ajuda do Revo.</a
    >
  </div>
</div>
```
...
### Área de Conteúdo Principal - Lista de Tarefas de Exclusão

Quando há tarefas de exclusão cadastradas, a interface exibe uma tabela com os registros:
    ...
    <table class="tabela">
      ...
      <tbody class="tabela-corpo">
        ...
        <tr class="tabela-linha">
          ...
          <td class="tabela-celula">Clientes</td>
          <td class="tabela-celula">
...
### Modal de Inclusão de Tarefa de Exclusão

```javascript
document.addEventListener('DOMContentLoaded', function() {
  // Referências aos elementos
  const botaoIncluirTarefaExclusao = document.querySelector('a[href="/incluir_tarefa_exclusao"]');

  // Função para abrir modal de inclusão de tarefa de exclusão
  function abrirModalIncluirTarefaExclusao(event) {
    ...
    modalTitulo.textContent = 'Incluir Tarefa de Exclusão';
    ...
    // Formulário de tarefa de exclusão
    modalCorpo.innerHTML = `
      <form class="formulario">
        <div class="formulario-grupo">
          <label class="formulario-label">Tipo de Exclusão</label>
          <div class="formulario-opcoes">
            <label class="formulario-opcao">
              <input type="radio" name="tipo_exclusao" value="pedidos" checked />
